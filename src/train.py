...
def train_and_save_models(data_file=path):
    """
    Entraîner les 3 modèles et sauvegarder les meilleurs
    """
    try:
        # Charger les données
        ...
        # Assumant que 'price' est la colonne target
        if 'price' not in df.columns:
            # Prendre la dernière colonne comme target si 'price' n'existe pas
        ...
        # Standardisation pour Linear Regression
